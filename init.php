<?php
	...
	#create tables
	$db->query("CREATE TABLE Users (ID bigint primary key NOT NULL AUTO_INCREMENT, fb_ID bigint, Name char(50), Email char(35), DisplayName char(35), Password char(100))") or die ("Invalid create " . $db->error);
